...
export default function MyCourse() {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={{height:160,backgroundColor:'blue',padding:30}}>
      <Text style={{fontWeight:'bold',color:'white',fontSize:24}}>My Courses</Text>
      </View>
      ...
      </View><View style={styles.fourthrow}>
