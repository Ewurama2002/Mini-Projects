...
const data = {
    'Year 1': {
      chapters: {
        " DIVERSITY OF MATTER ": ["Introduction to Integrated Science", "Measurements"],
        " CYCLES ": ["Air Movement", "Nitrogen Cycle"],
      }
    },
    'Year 2': {
      chapters: {
          " DIVERSITY OF MATTER ": ["Acids, Bases and Salts", "Water"],
          " CYCLES ": ["General principles of farm animal production", "Hydrological Cycle"],
        }
    },
    'Year 3': {
      chapters: {
          " DIVERSITY OF MATTER ": ["Metals And Non-Metals", "Exploitation of minerals"],
          " CYCLES ": ["Life Cycle of Pests and Parasites", "Crop Production"],
        }
    }
  };
  ...
  const renderUnits = (units) => (
    units.map((unit, index) => (
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('unit3ex')} // Navigate to UnitPage
      >
        <Text>{unit}</Text>
      </TouchableOpacity>
    ))
